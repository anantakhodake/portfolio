      ...
      <div className="container-c" id="contact">
        ...
        >
          <div className="contact-info">
            ...
            <div className="social-media">
              ...
              <div className="social-icons">
                <a
                  href="https://www.facebook.com/yogesh.bari.1069"
                  target="_blank"
                ...
                <a
                  href="https://twitter.com/pranav_dharme_"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://www.instagram.com/pranav_dharme_/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://discordapp.com/users/pieCharm"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="contact-form">
            ...
            <span
              style={{ fontWeight: "bold", marginLeft: "6%", color: "#fff" }}
            >
